  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route path="/mobiles/product/:id" element={<AppImport.MobilesProductDetails />} />
        <Route path="/laptops/product/:id" element={<AppImport.LaptopsProductDetails />} />
        <Route path="/homeGoods/product/:id" element={<AppImport.HomeGoodsProductDetails />} />
