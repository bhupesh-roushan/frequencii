...
const Login = ({openSignUpForm}) => {
  return (
    <div className='m-5 shadow-lg shadow-blue-200 p-5 rounded-lg'>
      ...
      <form action="">
        <div className='mb-4'>
            <Label htmlFor="" className="block text-gray-700 pb-2">Email</Label>
            <Input type="email" className="w-full px-3 py-2 border" placeholder="Enter Email"></Input>
        </div>

        <div className='mb-4'>
            <Label htmlFor=""  className="block text-gray-700 pb-2">Password</Label>
        ...
        <div className='mb-4'>
            <Button variant="outline" type="submit" className="w-full bg-red-600 text-white py-2 ">Login</Button>
        </div>
      </form>

        <div className='text-center'>
            <span className='text-gray-700'>Don't have an Account?</span>
            <Button variant="destructive" className="ml-2 shadow-md shadow-blue-200" onClick={openSignUpForm}>Sign Up</Button>
        </div>
