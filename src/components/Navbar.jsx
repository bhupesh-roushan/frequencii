        ...
        <div className="container mx-auto px-1 md:px-4 lg:px-5 py-4 flex justify-between items-center">
          ...
          <div className="relative flex-1 mx-4">
            ...
            >
              ...
              />
              <FaSearch
                className="absolute text-sm sm:text-lg top-3 right-3 hover:scale-125 hover:text-gray-600 transition-all delay-120 ease-in text-gray-500 cursor-pointer"
          ...
          <div className="flex flex-row justify-center items-center space-x-5">
            <Link to="/cart">
              <div className="relative">
                <FaShoppingCart className="text-xl sm:text-3xl text-gradient-title hover:scale-105 transition-all delay-120 ease-in" />
                {products.length > 0 && (
            ...
            <Button
              variant="outline"
              className="hidden md:block bg-white shadow-md shadow-blue-200 gradient-title transition-all ease-in delay-110 rounded-lg"
